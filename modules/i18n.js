...
const DICT = {
  id: {
    ...
    greeting:
      "Halo! Saya Morby Ver1.0, the Bank Mortgage Buddy untuk KPR the Bank Indonesia. Saya bisa menjawab pertanyaan seputar KPR, " +
    ...
    sug_cashback_q: "Berapa cashback maksimal program KPR ini dan apa syaratnya?",
    sug_docs_l: "Dokumen",
    ...
    /* Reference number + application status */
    ref_save_label: "SIMPAN NOMOR REFERENSI ANDA",
    ref_save_hint: "Simpan nomor ini. Ketik nomor ini di chat kapan saja untuk mengecek status pengajuan Anda.",
    ref_copy: "Salin",
    ref_copied: "✓ Tersalin",
    status_ask_ref: "Tentu. Mohon ketik **nomor referensi** pengajuan Anda (format: 20260101-1230-12345) untuk saya cek statusnya.",
    status_checking: "Mengecek status untuk No. Ref {ref}…",
    status_invalid: "Format nomor referensi tidak sesuai. Contoh yang benar: 20260101-1230-12345.",
    status_error: "Maaf, terjadi kendala saat mengecek status. Mohon coba lagi.",
    status_notfound: "Nomor referensi {ref} tidak ditemukan. Pastikan sudah benar, atau pengajuan mungkin belum tercatat.",
    status_result_label: "Status pengajuan — No. Ref {ref}",
    status_result_hint: "Atas nama {nama} · {jenis}. Status dapat berubah seiring proses. Ketik ulang nomor ref untuk pembaruan.",
    /* Simulation */
    sim_title: "Simulasi Angsuran & Cashback",
    calc_link: "Kalkulator",
    calc_open: "Buka Kalkulator →",
    calc_intro: "Hitung estimasi angsuran bulanan dan potensi cashback. Semua angka bersifat simulasi dan tidak mengikat.",
    calc_download: "Unduh PDF",
    calc_back: "← Kembali ke chat",
    calc_pdf_title: "Simulasi Angsuran KPR",
    calc_pdf_disclaimer: "PERHATIAN: Perhitungan ini bersifat SIMULASI dan TIDAK MENGIKAT. Angka final mengikuti analisa kredit dan Perjanjian Kredit the Bank. Bukan penawaran resmi maupun keputusan kredit.",
    calc_pdf_generated: "Dibuat pada",
    ...
    sim_ssut: "Syarat: wajib membeli unit trust/reksa dana via fitur Wealth Feature pada aplikasi Digital Bank.",
    sim_cashback_low: "Cashback dihitung dari plafon kredit sesuai kategori program.",
  ...
  en: {
    ...
    greeting:
      "Hi! I'm Morby Ver1.0, your the Bank Mortgage Buddy for KPR at the Bank Indonesia. I can answer mortgage (KPR) questions, " +
    ...
    sug_cashback_l: "Cashback promo",
    sug_cashback_q: "What is the maximum cashback for this mortgage program and its requirements?",
    ...
    /* Reference number + application status */
    ref_save_label: "SAVE YOUR REFERENCE NUMBER",
    ref_save_hint: "Keep this number. Type it in the chat anytime to check your application status.",
    ref_copy: "Copy",
    ref_copied: "✓ Copied",
    status_ask_ref: "Sure. Please type your application **reference number** (format: 20260101-1230-12345) and I'll check its status.",
    status_checking: "Checking status for Ref No. {ref}…",
    status_invalid: "That reference number format is invalid. A correct example: 20260101-1230-12345.",
    status_error: "Sorry, something went wrong checking the status. Please try again.",
    status_notfound: "Reference number {ref} was not found. Please check it, or the application may not be recorded yet.",
    status_result_label: "Application status — Ref No. {ref}",
    status_result_hint: "For {nama} · {jenis}. Status changes as the process progresses. Re-type the ref for updates.",
    sim_title: "Installment & Cashback Simulation",
    calc_link: "Calculator",
    calc_open: "Open Calculator →",
    calc_intro: "Estimate the monthly installment and potential cashback. All figures are a simulation and non-binding.",
    calc_download: "Download PDF",
    calc_back: "← Back to chat",
    calc_pdf_title: "KPR Installment Simulation",
    calc_pdf_disclaimer: "NOTE: This calculation is a SIMULATION and NON-BINDING. Final figures follow the Bank's credit analysis and Credit Agreement. Not an official offer or a credit decision.",
    calc_pdf_generated: "Generated on",
    ...
    sim_ssut: "Condition: must buy unit trust / mutual fund via the Wealth Feature in the Digital Bank app.",
    sim_cashback_low: "Cashback is based on the credit limit per the program category.",
