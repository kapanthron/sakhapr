...
const DICT = {
  id: {
    ...
    sug_takeover_q: "Saya mau take over KPR dari bank lain ke UOB. Bagaimana caranya dan apa syaratnya?",
    sug_income_l: "Syarat penghasilan",
    sug_income_q: "Berapa minimum gaji untuk mengajukan KPR UOB?",
    ...
    sug_process_q: "Berapa lama proses KPR UOB dari pengajuan sampai akad?",
    ...
    set_primary: "KPR Primary (beli baru di developer)",
    set_secondary: "KPR Secondary (beli properti bekas)",
    set_take_over: "KPR Take Over (pindah dari bank lain)",
    ...
    rate_intro: "Berikut tabel suku bunga KPR UOB:",
    data_load_fail:
    ...
    ektp_forwarding: "Meneruskan berkas ke UOB…",
    ektp_done: "Terima kasih. Data Anda telah diteruskan ke tim UOB Mortgage Relations untuk ditindaklanjuti. (No. Ref: {ref}).",
    ektp_done_chat: "Pengajuan Anda sudah kami terima dan teruskan ke tim UOB. Tim akan menghubungi Anda. Terima kasih!",
    ektp_fail: "Maaf, terjadi kendala saat meneruskan data. Mohon coba lagi.",
    /* Simulation */
    sim_title: "Simulasi Angsuran & Cashback",
    sim_disclaimer: "Estimasi memakai suku bunga dari knowledge base UOB. Angka final mengikuti analisa kredit dan Perjanjian Kredit.",
    ...
    sim_run: "Hitung",
    fac_primary: "KPR Primary",
    fac_secondary: "KPR Secondary",
    fac_take_over: "KPR Take Over",
    seg_new: "New to Bank / lainnya",
    seg_pv: "UOB Privilege (PV)",
    seg_wb: "UOB Wealth (WB)",
    ...
    sim_ssut: "Syarat: wajib membeli unit trust/reksa dana via SSUT di UOB TMRW.",
    ...
    rate_jenis_primary: "Primary",
    rate_jenis_secondary: "Secondary / Take Over",
    rate_year: "Th",
  ...
  en: {
    ...
    sug_income_q: "What is the minimum income to apply for a UOB mortgage?",
    ...
    sug_process_q: "How long does the UOB mortgage process take from application to signing?",
    ...
    set_primary: "KPR Primary (buying new from a developer)",
    set_secondary: "KPR Secondary (buying a used property)",
    set_take_over: "KPR Take Over (moving from another bank)",
    ...
    rate_intro: "Here is the UOB mortgage interest-rate table:",
    data_load_fail:
    ...
    ektp_forwarding: "Forwarding the files to UOB…",
    ektp_done: "Thank you. Your data has been forwarded to the UOB Mortgage Relations team for follow-up. (Ref No.: {ref}).",
    ektp_done_chat: "We've received your application and forwarded it to the UOB team. They will contact you. Thank you!",
    ektp_fail: "Sorry, something went wrong forwarding the data. Please try again.",
    sim_title: "Installment & Cashback Simulation",
    sim_disclaimer: "Estimates use the interest rates from the UOB knowledge base. Final figures follow credit analysis and the Credit Agreement.",
    ...
    sim_ssut: "Condition: must buy unit trust / mutual fund via SSUT in UOB TMRW.",
    ...
    rate_flexi: "KPR Flexi Primary: SRBI + 2.50% (≈ {pct}%), floating from the start.",
  },
};
