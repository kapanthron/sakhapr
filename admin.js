...
const CMS_FILE_LABEL = { chatlog: "Log chat", prescreen_xls: "Prescreen", pariksa_pdf: "Laporan NIK (.pdf)", ektp_data: "Data eKTP (.txt)", pasfoto: "Pas foto (.jpg)" };
...
function renderCmsLeads(leads) {
  ...
  for (const l of leads) {
    ...
    const order = ["ektp_data", "pasfoto", "prescreen_xls", "pariksa_pdf", "chatlog"];
