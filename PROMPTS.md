# SakhaPR — Claude Code Build Prompts
...
```
You are building "SakhaPR", a privacy-first, browser-only GenAI mortgage assistant for UOB
...
- knowledge_base.json  (SakhaPR master KB; quote figures exactly, use the calculators block for
...
"SakhaPR lead + eKTP screening" and a body summarising product, prescreen status, and NIK
